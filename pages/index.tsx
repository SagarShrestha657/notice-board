...
export default function Home({ initialNotices, initialHasMore }: HomeProps) {
  // Safe fallback: guard against undefined props during hydration
...
// Fetch the first page of data on the server instantly
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const serializedNotices = notices.map((notice: (typeof notices)[number]) => ({
    ...notice,
  ...
  return {
    props: {
      ...
      initialHasMore: limit < totalCount,
    }
  };
}
